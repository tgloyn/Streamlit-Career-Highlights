...
with tabs[0]:
    ...
    st.image(f'{IMAGE_PATH}/surge_dash_demo.png', caption='Streamlit Dashboard Demo', use_container_width=True)
...
with tabs[1]:
    ...
    with vis_1:
        st.image(f'{IMAGE_PATH}/patient_classifier_roc_curve.png', caption='ROC Curve from Patient Classifier', use_container_width=True)
    with vis_2:
        st.image(f'{IMAGE_PATH}/patient_classifier_conf_matrix.png', caption='Confusion Matrix Results', use_container_width=True)
...
with tabs[2]:
    ...
    st.warning("Samples are for illustrative purposes only; data is confidential and not publicly shareable.")
    st.image(f'{IMAGE_PATH}/CI sample 1.png', caption='Example Visual from Report', use_container_width=False)
    st.image(f'{IMAGE_PATH}/CI sample 2.png', caption='Example Visual from Report', use_container_width=False)
...
with tabs[3]:
    ...
    st.image(f'{IMAGE_PATH}/virtual_care_trend_ex.png', caption='XGBoost Forecasting Results', use_container_width=False)
...
with tabs[4]:
    ...
    st.image(f'{IMAGE_PATH}/gta_venue_map.png', caption='Map of Toronto Venue Locations **Visualization purposes only, not generated by me**', use_container_width=False)
